    ...
    def _built_RNN(self):
        ...
        with tf.name_scope('RNN'):
            ...
            with tf.variable_scope('output_layer'):
                ...
                cell_outputs_reshaped = tf.reshape(tf.concat(axis=1, values=self.cell_outputs), [-1, self._cell_size])
...
if __name__ == '__main__':
    ...
    with tf.variable_scope('rnn') as scope:
        ...
        print("train_config", train_config.time_steps)
        print("train_config", train_config.batch_size)
        scope.reuse_variables()
        test_rnn2 = RNN(test_config)
        print("test_config", test_config.time_steps)
        print("test_config", test_config.batch_size)
